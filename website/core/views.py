...
class IndexView(TemplateView):
                    ...
                    favorite_categories.append(
                        {
                            "category": item,
                            "min_price": (
                                min_price_product.prices.first().price if min_price_product.prices.exists() else None
                            ),
    ...
    def get_daily_offer_and_limited_editions(self):
        ...
        if offers is None:
            limited_edition_products = Price.objects.select_related("product").filter(product__limited_edition=True)
