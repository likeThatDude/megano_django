...
from .views import (AddProductInCart, DeleteProductInCart, DetailCart,
                    GetTotalPriceCart, GetTotalQuantityCart,
...
urlpatterns = [
    ...
    path(
        "delete/<int:product_id>/", DeleteProductInCart.as_view(), name="delete_product"
    ),
    path(
